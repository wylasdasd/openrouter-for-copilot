...
export const VISION_PROXY_CONFIG_KEY = 'openrouter-for-copilot.visionProxy.config';
export const VISION_PROXY_SOURCE_KEY = 'openrouter-for-copilot.visionProxy.source';
export const VISION_PROXY_API_KEY_SECRET = 'openrouter-for-copilot.visionProxy.apiKey';
